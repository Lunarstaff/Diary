...
def download_ts(url_ts):
    # 显示子进程信息
    print("download_ts子进程ID{:*>15}\n正在下载：{}".format(os.getpid(), url_ts))
...
# 执行windowns下的copy命令
def connect_ts(mp4_name):
    '''
    copy *.ts /B 18.mp4
    '''
    cmd_str = "copy *.ts /B {}.mp4".format(mp4_name)
    os.system(cmd_str)
...
if __name__ == "__main__":
    ...
    get_ts_N(url_down_refer, 1360)
    connect_ts(moive_url_in_aiqiyi[-15:-5])
